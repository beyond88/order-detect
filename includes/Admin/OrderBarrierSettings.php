...
class OrderBarrierSettings
{
    ...
    {
        add_action('order_barrier_settings_header', array(__CLASS__, 'header_template'), 10);
        add_action('orderbarrier_settings_footer', array(__CLASS__, 'footer_template'), 10);
    }

    /**
     * This function is responsible for settings page header
     *
     * @hooked order_barrier_settings_header
     * @since   1.0.0
     * @access  public
     * @param   none
     * @return  void
    ...
    {
?>
        <div class="order-barrier-settings-header">
            <div class="order-barrier-header-full">
                <img src="<?php echo ORDERBARRIER_ASSETS ?>/img/order-barrier-logo.jpeg" alt="Order Barrier">
                <h2 class="title"><?php _e('Order Barrier Settings', 'order-barrier'); ?></h2>
            </div>
        </div>
    <?php
    }
    ...
    {
    ?>
        <div class="order-barrier-settings-documentation">
            <div class="order-barrier-settings-row">
                <div class="order-barrier-admin-block order-barrier-admin-block-docs">
                    <header class="order-barrier-admin-block-header">
                        <div class="order-barrier-admin-block-header-icon">
                        ...
                        <h4 class="order-barrier-admin-title"><?php echo __('Documentation', 'order-barrier'); ?> </h4>
                    </header>
                    <div class="order-barrier-admin-block-content">
                        <p><?php echo __('Get started by spending some time with the documentation to get familiar with OrderBarrier. Build an awesome Knowledge Base for your customers with ease.', 'order-barrier'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/order-barrier/wiki" class="order-barrier-button" target="_blank"><?php echo __('Documentation', 'order-barrier'); ?></a>
                    </div>
                </div>
                <div class="order-barrier-admin-block order-barrier-admin-block-contribute">
                    <header class="order-barrier-admin-block-header">
                        <div class="order-barrier-admin-block-header-icon">
                        ...
                        <h4 class="order-barrier-admin-title"><?php echo __('Join Our Community', 'order-barrier'); ?></h4>
                    </header>
                    <div class="order-barrier-admin-block-content">
                        <p><?php echo __('Join the Facebook community and discuss with fellow developers and users. Best way to connect with people and get feedback on your projects.', 'order-barrier'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/order-barrier/issues" class="order-barrier-button" target="_blank"><?php echo __('Join Now', 'order-barrier'); ?> </a>
                    </div>
                </div>
                <div class="order-barrier-admin-block order-barrier-admin-block-need-help">
                    <header class="order-barrier-admin-block-header">
                        <div class="order-barrier-admin-block-header-icon">
                            <svg enable-background="new 0 0 500 500" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <h4 class="order-barrier-admin-title"><?php echo __('Need Help?', 'order-barrier'); ?></h4>
                    </header>
                    <div class="order-barrier-admin-block-content">
                        <p><?php echo __('Stuck with something? Get help from live chat or support ticket.', 'order-barrier'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/order-barrier/issues" class="order-barrier-button" target="_blank"><?php echo __('Initiate a Chat', 'order-barrier'); ?></a>
                    </div>
                </div>
                <div class="order-barrier-admin-block order-barrier-admin-block-community">
                    <header class="order-barrier-admin-block-header">
                        <div class="order-barrier-admin-block-header-icon">
                            <svg enable-background="new 0 0 500 500" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <h4 class="order-barrier-admin-title"><?php echo __('Show Your Love', 'order-barrier'); ?></h4>
                    </header>
                    <div class="order-barrier-admin-block-content">
                        <p><?php echo __('We love to have you in OrderBarrier family. We are making it more awesome everyday. Take your 2 minutes to review the plugin and spread the love to encourage us to keep it going.', 'order-barrier'); ?></p>
                        <a rel="nofollow" href="https://wordpress.org/support/plugin/order-barrier/reviews/#new-post" class="order-barrier-button" target="_blank"><?php echo __('Leave a Review', 'order-barrier'); ?></a>
                    </div>
                </div>
            </div>
        </div>
<?php
    ...
    public static function setting_fields()
    {
        ...
        $setting_fields = array(
            'tabs' => apply_filters(
                'order_barrier_builder_tabs',
                array(
                    'general_settings'    => array(
                        'title'       => __('General', 'order-barrier'),
                        'icon'        => '',
                        'sections'     => apply_filters(
                            'order_barrier_general_settings_sections',
                            array(
                                'pathao_settings' => array(
                                    'title'  => __('Pathao', 'order-barrier'),
                                    'fields' => array(
                                        array(
                                            'name'          => 'pathao_api_endpoint',
                                            'label'         => __('API Endpoint', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set API Endpoint', 'order-barrier'),
                                            'placeholder'   => __('API Endpoint', 'order-barrier'),
                                        ),
                                        array(
                                            'name'          => 'pathao_api_key',
                                            'label'         => __('API Key', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set API Key', 'order-barrier'),
                                            'placeholder'   => __('API Key', 'order-barrier'),
                                        ),
                                        array(
                                            'name'          => 'pathao_secret_key',
                                            'label'         => __('Secret Key', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set Secret Key', 'order-barrier'),
                                            'placeholder'   => __('Secret Key', 'order-barrier'),
                                        ),
                                    )
                                ),
                                'steadfast_settings' => array(
                                    'title'  => __('SteadFast', 'order-barrier'),
                                    'fields' => array(
                                        array(
                                            'name'          => 'steadfast_api_endpoint',
                                            'label'         => __('API Endpoint', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Ex.:</strong> https://portal.steadfast.com.bd/api/v1', 'order-barrier'),
                                            'placeholder'   => __('API Endpoint', 'order-barrier'),
                                        ),
                                        array(
                                ...
                                'redx_settings' => array(
                                    'title'  => __('REDX', 'order-barrier'),
                                    'fields' => array(
                                        array(
                                            'name'          => 'redx_api_endpoint',
                                            'label'         => __('API Endpoint', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set API Endpoint', 'order-barrier'),
                    ...
                    'otp_settings'    => array(
                        'title'       => __('OTP Verification', 'order-barrier'),
                        'icon'        => '',
                        'sections'     => apply_filters(
                            'order_barrier_otp_settings_sections',
                            array(
                                'otp_settings' => array(
                                    'title'  => __('Settings', 'order-barrier'),
                                    'fields' => array(
                                        array(
                                            'name'          => 'enable_otp',
                                            'label'         => __('Enable', 'order-barrier'),
                                            'type'          => 'checkbox',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('', 'order-barrier'),
                                            'placeholder'   => __('', 'order-barrier'),
                                        ),
                                        array(
                                            ...
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set SMS Provider API Endpoint', 'order-barrier'),
                                            'placeholder'   => __('API Endpoint', 'order-barrier'),
                                        ),
                                        array(
                                            'name'          => 'sms_api_key',
                                            'label'         => __('SMS Provider API', 'order-barrier'),
                                            'type'          => 'text',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set SMS Provider API Key', 'order-barrier'),
                                            'placeholder'   => __('SMS Provider API Key', 'order-barrier'),
                                        ),

                                        array(
                                            'name'          => 'sms_balance',
                                            'label'         => __('SMS Balance', 'order-barrier'),
                                            'type'          => 'html',
                                            'class'         => 'order-barrier-settings-field',
                                            'description'   => __('Your current sms balance', 'order-barrier'),
                                            'placeholder'   => __('', 'order-barrier'),
                                        ),
                                    )
                                )
                    ...
                    // 'message_tab'   => array(
                    //     'title'     => __('Message', 'order-barrier'),
                    //     'icon'      => '',
                    //     'sections'   => apply_filters(
                    ...
                    //                         'label'         => __('Message', 'order-barrier'),
                    //                         'type'          => 'text',
                    //                         'class'         => 'order-barrier-settings-field',
                    //                         // 'description'   => __('<strong>Note:</strong> {product} and {qty} for dynamic content.', 'order-barrier'),
                    //                         'placeholder'   => __('', 'order-barrier'),
                    //                     ),
                    //                 )
                    //             )
        ...
        return apply_filters('order_barrier_setting_fields', $setting_fields);
    }
}
