...
<div id="samply-tab" class="panel wc-metaboxes-wrapper woocommerce_options_panel">
    ...
    <div class="options_group">
        <p class="form-field comment_status_field">
            <label for="manage_stock"><?php esc_html_e('Manage stock?', 'order-shield'); ?></label>
        ...
        <p class="form-field menu_order_field samply-enable-area">
            <label for="samply_qty"><?php esc_html_e('Stock quantity', 'order-shield'); ?></label>
        ...
        <div class="options_group">
            <p class="form-field">
                <label for="samply_price">
                    <?php esc_html_e('Sample Price', 'order-shield'); ?>
