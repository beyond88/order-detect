<table class="form-table">
    <tbody id="append_body">
            ...
            ?>
                <tr valign="top">
                    <td class="middle-align">
                        <input type="text" name="<?php echo esc_html($this->_optionName . "[" . $value['name'] . "]"); ?>[qty][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e('Quantity', 'order-detect'); ?>" value="<?php echo esc_attr($val); ?>">
                        <input type="text" name="<?php echo esc_html($this->_optionName . "[" . $value['name'] . "]"); ?>[price][]" maxlength="30" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e('Price', 'order-detect'); ?>" value="<?php echo esc_attr($setting_options[$value['name']]['price'][$i]); ?>">
                        <a href="javascript:void(0);" class="remove_button" title="Remove"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
                                <g>
                                    ...
                                    <path class="st0" d="M88.7,16.3c-0.3-2.7-2.6-4.8-5.4-5.2c-1.1-0.2-2.2-0.2-3.3-0.2c-4.2,0-8.4,0-12.9,0c0-1.4,0-2.6,0-3.8 C66.9,2.7,64.2,0,59.7,0c-6.6,0-13.2,0-19.8,0c-4.2,0-7,2.7-7.2,6.9c-0.1,1.2,0,2.5,0,3.9c-1.1,0-1.9,0.1-2.7,0.1c-4,0-8-0.1-12,0 c-3.3,0.1-6.1,1.7-6.7,4.5c-0.6,2.5-0.4,5.2-0.6,7.9c26.3,0,52.1,0,78.1,0C88.7,20.9,88.9,18.6,88.7,16.3z" />
                                </g>
                                <g></g>
                                <g></g>
                                <g></g>
        ...
        <?php } else { ?>
            <tr valign="top">
                <td class="middle-align">
                    <input type="text" name="<?php echo esc_html($this->_optionName . "[" . $value['name'] . "]"); ?>[qty][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e('Quantity', 'order-detect'); ?>">
                    <input type="text" name="<?php echo esc_html($this->_optionName . "[" . $value['name'] . "]"); ?>[price][]" maxlength="30" value="" class="timezone_string wfps-meta-field playfield" placeholder="<?php esc_html_e('Price', 'order-detect'); ?>">
                </td>
            </tr>
        <?php } ?>
    </tbody>
        ...
        <td class="middle-align">
            <div class="wfps-click-area-wrapper">
                ...
                <label for="add-field" class="wfps-group-field-add">
                    ...
                    <span class="rx_add_field_label"><?php esc_html_e('Add Sample Price', 'order-detect'); ?></span>
