...
?>
        <div class="samply-settings-header">
            <div class="samply-header-full">
                <img src="<?php echo ORDERSHIELD_ASSETS ?>/img/samply-logo.svg" alt="Order Shield">
            ...
            <div class="samply-settings-row">
                <div class="samply-admin-block samply-admin-block-docs">
                    <header class="samply-admin-block-header">
                        ...
                        <h4 class="samply-admin-title"><?php echo __('Documentation', 'order-shield'); ?> </h4>
                    </header>
                    <div class="samply-admin-block-content">
                        <p><?php echo __('Get started by spending some time with the documentation to get familiar with Samply. Build an awesome Knowledge Base for your customers with ease.', 'order-shield'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/samply/wiki" class="samply-button" target="_blank"><?php echo __('Documentation', 'order-shield'); ?></a>
                    </div>
                </div>
                <div class="samply-admin-block samply-admin-block-contribute">
                    <header class="samply-admin-block-header">
                        ...
                        <h4 class="samply-admin-title"><?php echo __('Join Our Community', 'order-shield'); ?></h4>
                    </header>
                    <div class="samply-admin-block-content">
                        ...
                        <a rel="nofollow" href="https://github.com/beyond88/samply/issues" class="samply-button" target="_blank"><?php echo __('Join Now', 'order-shield'); ?> </a>
                    </div>
                </div>
                <div class="samply-admin-block samply-admin-block-need-help">
                    <header class="samply-admin-block-header">
                        ...
                        <h4 class="samply-admin-title"><?php echo __('Need Help?', 'order-shield'); ?></h4>
                    </header>
                    <div class="samply-admin-block-content">
                        <p><?php echo __('Stuck with something? Get help from live chat or support ticket.', 'order-shield'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/samply/issues" class="samply-button" target="_blank"><?php echo __('Initiate a Chat', 'order-shield'); ?></a>
                    </div>
                </div>
                <div class="samply-admin-block samply-admin-block-community">
                    <header class="samply-admin-block-header">
                        ...
                        <h4 class="samply-admin-title"><?php echo __('Show Your Love', 'order-shield'); ?></h4>
                    </header>
                    <div class="samply-admin-block-content">
                        <p><?php echo __('We love to have you in Samply family. We are making it more awesome everyday. Take your 2 minutes to review the plugin and spread the love to encourage us to keep it going.', 'order-shield'); ?></p>
                        <a rel="nofollow" href="https://wordpress.org/support/plugin/samply/reviews/#new-post" class="samply-button" target="_blank"><?php echo __('Leave a Review', 'order-shield'); ?></a>
                    </div>
                </div>
            </div>
        </div>
<?php
                ...
                array(
                    'general_settings'    => array(
                        ...
                        'sections'     => apply_filters(
                            'samply_general_settings_sections',
                            array(
                                'general_settings' => array(
                                    ...
                                    'fields' => array(
                                        ...
                                        array(
                                            'name'          => 'button_label',
                                            'label'         => __('Button Label', 'order-shield'),
                                            'type'          => 'text',
                                            'class'         => 'samply-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set button label', 'order-shield'),
                                            'placeholder'   => __('Set button label', 'order-shield'),
                                        ),
                                        array(
                                            'name'          => 'disable_limit_per_order',
                                            'label'         => __('Disable Maximum Limit', 'order-shield'),
                                            'type'          => 'checkbox',
                                            'class'         => 'samply-settings-field',
                                            'description'   => __('<strong>Note:</strong> Disable maximum order limit validation', 'order-shield'),
                                        ),
                                        array(
                                            'name'          => 'limit_per_order',
                                            'label'         => __('Maximum Limit Type', 'order-shield'),
                                            'type'          => 'select',
                                            'class'         => 'samply-settings-field',
                                            'description'   => __('<strong>Note:</strong> Maximum limit type', 'order-shield'),
                                            'default'       => array(
                                                'product'   => 'Product',
                                                'all'       => 'Order',
                                            ),
                                        ...
                                        array(
                                            ...
                                            'label'         => __('Maximum Quantity Per Order', 'order-shield'),
                                            'type'          => 'number',
                                            'class'         => 'samply-settings-field',
                                            'description'   => __('<strong>Note:</strong> Maximum quantity per order', 'order-shield'),
                                            'placeholder'   => 5,
                                        ...
                                        array(
                                            ...
                                            'label'         => __('Hide in Shop/Categories Page', 'order-shield'),
                                            'type'          => 'checkbox',
                                            'class'         => 'samply-settings-field',
                                        ),
                                        array(
                                            'name'          => 'sample_price',
                                            'label'         => __('Sample Price', 'order-shield'),
                                            'class'         => 'samply-settings-field',
                                            'type'          => 'number',
                                            'description'   => __('Set Sample Price', 'order-shield'),
                                            'placeholder'   => '0.00',
                                            'value'            => 0.00,
                                            'position'        => 'tr'
                                        ),
    ...
    {
        $tabs = "<li class=\"samply_wc_product_tabs_tab\"><a href=\"#samply-tab\"><span>" . __('Product Sample', 'order-shield') . "</span></a></li>";
    ...
    public static function sample_price_to_variations($loop, $variation_data, $variation)
    {
        woocommerce_wp_text_input(array(
            ...
            'class' => 'short',
            'type'    => 'number',
            'label' => sprintf(__('Sample Price (%s)', 'order-shield'), get_woocommerce_currency_symbol()),
