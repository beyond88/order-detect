...
class OrderShieldSettings
{
    ...
    {
        add_action('order_shield_settings_header', array(__CLASS__, 'header_template'), 10);
        add_action('ordershield_settings_footer', array(__CLASS__, 'footer_template'), 10);
    }

    /**
     * This function is responsible for settings page header
     *
     * @hooked order_shield_settings_header
     * @since   1.0.0
     * @access  public
     * @param   none
     * @return  void
...
?>
    ...
    {
    ?>
        <div class="order-shield-settings-documentation">
            <div class="order-shield-settings-row">
                <div class="order-shield-admin-block order-shield-admin-block-docs">
                    <header class="order-shield-admin-block-header">
                        <div class="order-shield-admin-block-header-icon">
                        ...
                        <h4 class="order-shield-admin-title"><?php echo __('Documentation', 'order-shield'); ?> </h4>
                    </header>
                    <div class="order-shield-admin-block-content">
                        <p><?php echo __('Get started by spending some time with the documentation to get familiar with OrderShield. Build an awesome Knowledge Base for your customers with ease.', 'order-shield'); ?></p>
                        <a rel="nofollow" href="https://github.com/beyond88/order-shield/wiki" class="order-shield-button" target="_blank"><?php echo __('Documentation', 'order-shield'); ?></a>
                    </div>
                </div>
                <div class="order-shield-admin-block order-shield-admin-block-contribute">
                    <header class="order-shield-admin-block-header">
                        <div class="order-shield-admin-block-header-icon">
                        ...
                        <h4 class="order-shield-admin-title"><?php echo __('Join Our Community', 'order-shield'); ?></h4>
                    </header>
                    <div class="order-shield-admin-block-content">
                ...
                <div class="order-shield-admin-block order-shield-admin-block-need-help">
                    <header class="order-shield-admin-block-header">
                        ...
                        <h4 class="order-shield-admin-title"><?php echo __('Need Help?', 'order-shield'); ?></h4>
                    </header>
                    <div class="order-shield-admin-block-content">
                ...
                <div class="order-shield-admin-block order-shield-admin-block-community">
                    <header class="order-shield-admin-block-header">
                        ...
                        <h4 class="order-shield-admin-title"><?php echo __('Show Your Love', 'order-shield'); ?></h4>
                    </header>
                    <div class="order-shield-admin-block-content">
                        <p><?php echo __('We love to have you in OrderShield family. We are making it more awesome everyday. Take your 2 minutes to review the plugin and spread the love to encourage us to keep it going.', 'order-shield'); ?></p>
                        <a rel="nofollow" href="https://wordpress.org/support/plugin/order-shield/reviews/#new-post" class="order-shield-button" target="_blank"><?php echo __('Leave a Review', 'order-shield'); ?></a>
                    </div>
                </div>
            </div>
        </div>
<?php
    ...
    public static function setting_fields()
    {
        ...
        $setting_fields = array(
            'tabs' => apply_filters(
                'order_shield_builder_tabs',
                array(
                    'general_settings'    => array(
                        'title'       => __('General', 'order-shield'),
                        'icon'        => '',
                        'sections'     => apply_filters(
                            'order_shield_general_settings_sections',
                            array(
                                'pathao_settings' => array(
                                    'title'  => __('Pathao', 'order-shield'),
                                    'fields' => array(
                                        array(
                                            ...
                                            'description'   => __('<strong>Note:</strong> Set API Endpoint', 'order-shield'),
                                            'placeholder'   => __('API Endpoint', 'order-shield'),
                                        ),
                                        array(
                                            'name'          => 'pathao_api_key',
                                            'label'         => __('API Key', 'order-shield'),
                                            'type'          => 'text',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set API Key', 'order-shield'),
                                            'placeholder'   => __('API Key', 'order-shield'),
                                        ),
                                        array(
                                            'name'          => 'pathao_secret_key',
                                            'label'         => __('Secret Key', 'order-shield'),
                                            'type'          => 'text',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set Secret Key', 'order-shield'),
                                            'placeholder'   => __('Secret Key', 'order-shield'),
                                        ),
                                    )
                                ),
                                'steadfast_settings' => array(
                                    'title'  => __('SteadFast', 'order-shield'),
                                    'fields' => array(
                                        array(
                                            ...
                                            'type'          => 'text',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('<strong>Ex.:</strong> https://portal.steadfast.com.bd/api/v1', 'order-shield'),
                                            'placeholder'   => __('API Endpoint', 'order-shield'),
                                        ),
                                        array(
                    ...
                    'otp_settings'    => array(
                        'title'       => __('OTP Verification', 'order-shield'),
                        'icon'        => '',
                        'sections'     => apply_filters(
                            'order_shield_otp_settings_sections',
                            array(
                                'otp_settings' => array(
                                    'title'  => __('Settings', 'order-shield'),
                                    'fields' => array(
                                        array(
                                            'name'          => 'enable_otp',
                                            'label'         => __('Enable', 'order-shield'),
                                            'type'          => 'checkbox',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('', 'order-shield'),
