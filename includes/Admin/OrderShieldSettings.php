                            ...
                            array(
                                'general_settings' => array(
                                    ...
                                    'fields' => array(
                                        ...
                                        array(
                                            'name'          => 'pathao_api',
                                            'label'         => __('Pathao API', 'order-shield'),
                                            'type'          => 'text',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set Pathao API Key', 'order-shield'),
                                            'placeholder'   => __('Pathao API Key', 'order-shield'),
                                        ),

                                        array(
                                            'name'          => 'steadfast_api',
                                            'label'         => __('SteadFast API', 'order-shield'),
                                            'type'          => 'text',
                                            'class'         => 'order-shield-settings-field',
                                            'description'   => __('<strong>Note:</strong> Set SteadFast API Key', 'order-shield'),
                                            'placeholder'   => __('SteadFast API Key', 'order-shield'),
                                        ),
